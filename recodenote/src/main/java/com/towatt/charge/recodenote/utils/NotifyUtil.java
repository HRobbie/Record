...
import com.towatt.charge.recodenote.interface1.ProgressCallBack;
...
//        });
        ...
        CommentUtils.Get(download_url, null, new ProgressCallBack<File>() {
            @Override
            ...
            public void onLoading(long total, long current, boolean isDownloading) {
                double a1=total;
                double b1=current;
                double currentPro=(double)((b1/a1)*100);
                cBuilder.setProgress(100, (int)currentPro, false);
                sent();
            }
            ...
            public void onError(Throwable throwable, boolean b) {
                listener.onFailure(throwable,b);
            }
        ...
        x.http().get(requestParams,new ProgressCallBack<File>() {
            @Override
            public void onWaiting() {
    ...
    public interface DownLoadListener{
         ...
         void onFailure(Throwable t, boolean errorNo);
    }
}
